...
public class TypeCollectionVisitor extends AbstractTraversingNodeVisitor<Set<ITypeName>, Void> {
	...
	@Override
	public Void visit(IVariableDeclaration stmt, Set<ITypeName> seenVTypes) {
